import { SIGNUP_ON_CHANGE, SIGNUP_ON_SUBMIT, SIGNUP_ON_SUBMIT_SUCCESS, SIGNUP_ON_SUBMIT_ERROR } from "./SignupActions"
...
const SignupReducer = (state: SignupState = initState, action: any) => {
    switch (action.type) {
