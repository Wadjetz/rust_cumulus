...
export type LOAD_UNFOLLOWED_SOURCES = {
    type: "LOAD_UNFOLLOWED_SOURCES"
}
export function loadUnfollowedSources(): LOAD_UNFOLLOWED_SOURCES {
    return { type: "LOAD_UNFOLLOWED_SOURCES" }
}

export type LOAD_UNFOLLOWED_SOURCES_SUCCESS = {
    type: "LOAD_UNFOLLOWED_SOURCES_SUCCESS"
    sources: Source[]
}
...
export type LOAD_UNFOLLOWED_SOURCES_ERROR = {
    type: "LOAD_UNFOLLOWED_SOURCES_ERROR"
    error: any
}
...
export type LOAD_MY_SOURCES = {
    type: "LOAD_MY_SOURCES"
}
export function loadMySources(): LOAD_MY_SOURCES {
    return { type: "LOAD_MY_SOURCES" }
}

export type LOAD_MY_SOURCES_SUCCESS = {
    type: "LOAD_MY_SOURCES_SUCCESS"
    sources: Source[]
    stats: SourceStat[]
}
export function loadMySourcesSuccess(sources: Source[], stats: SourceStat[]): LOAD_MY_SOURCES_SUCCESS {
    return { type: "LOAD_MY_SOURCES_SUCCESS", sources, stats }
}

export type LOAD_MY_SOURCES_ERROR = {
    type: "LOAD_MY_SOURCES_ERROR"
    error: any
}
...
export type FALLOW_SOURCE_SUCCESS = {
    type: "FALLOW_SOURCE_SUCCESS"
    source: Source
}
...
export type FALLOW_SOURCE_ERROR = {
    type: "FALLOW_SOURCE_ERROR"
    error: any
}
...
export type ADD_SOURCE_SUCCESS = {
