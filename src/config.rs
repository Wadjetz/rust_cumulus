...
impl Config {
    pub fn new(secret_key: String, database_url: String, mercury_api_key: String, rss_job_interval: u64) -> Self {
    ...
    pub fn from_env() -> Self {
        ...
        let rss_job_interval = rss_job_interval.parse().expect("RSS_JOB_INTERVAL must be an integer");
